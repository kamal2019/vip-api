...
router
  .route('/:userId/special')
  .patch(auth('specialManageUser'), validate(userValidation.updateUserSpecial), userController.updateUserSpecial);

router
  .route('/profilepic/:userId')
  .patch(auth('manageUser'), validate(userValidation.updateProfilePic), userController.updateProfilePic);
